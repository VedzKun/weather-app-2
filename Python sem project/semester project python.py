...
def getWeather():
    try:
        ...
        #weather
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=d3ccc2fa2fecfec67916bb1560cde306"
        ...
        messagebox.showerror("Error","Please enter correct city name \n or check your internet connection")
...
#search icon
Searchicon=PhotoImage(file="copy_search.png")
